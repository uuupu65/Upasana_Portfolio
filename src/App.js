  ...
  const projects = [
    {
      ...
      description: 'A website built using html and css used for business.',
    ...
    },
    {
      id: 2,
      title: 'Nyano Kakh',
      description: 'A baby balnekt that measure babies vital and shows the data in the web app.',
    ...
    },
    {
      ...
      description: 'A simple tinkercad simulation of smart garden system.',
                  ...
                  {items.map((skill, index) => (
                    <div key={index} className="skill-item">
                      ...
                      <div className="skill-bar">
                        <div className="skill-progress" style={{width: `${65 + (index * 10)}%`}}></div>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="contact-details">
                ...
                <div className="contact-item">
                  <span>📞</span>
                  <span>+977 9818794067</span>
                  </div>
              </div>
              <div className="social-links">
  <a href="https://www.linkedin.com/in/upasana-neupane/" target="_blank" rel="noopener noreferrer" className="social-link">
    <i className="fab fa-linkedin"></i> LinkedIn
  </a>
  <a href="https://github.com/uuupu65" target="_blank" rel="noopener noreferrer" className="social-link">
    <i className="fab fa-github"></i> GitHub
      ...
      <footer className="footer">
        <div className="container">
          <p>&copy; 2025 Upasana Neupane. All rights reserved.</p>
        </div>
      </footer>
